...
\begin{tikzpicture}
\tkzKiviatDiagram[scale=0.5,label distance=3cm,radial=10,gap=1,lattice=10]
...
\tkzKiviatGrad[prefix=,unity=0.5](1)
\end{tikzpicture}
...
\tkzKiviatLine[ultra thick,color=green,mark=ball,mark size=4pt,
               fill=green!20,opacity=0.5](236.2,391,303)
\tkzKiviatLine[ultra thick,color=red,mark=ball,mark size=4pt,
               fill=red!20,opacity=0.5](129,470,292)
\tkzKiviatGrad[prefix=,unity=50](1)
\end{tikzpicture}
